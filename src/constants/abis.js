...
const { abi: testERC1155ABI } = require('../artifacts/contracts/TestERC1155.sol/TestERC1155.json'); // ✅ Corrected variable name

export const TOKEN_ABI = testTokenABI;
export const NFT_ABI = testNFTABI;
export const ERC1155_ABI = testERC1155ABI; // ✅ Now correctly references the imported variable
